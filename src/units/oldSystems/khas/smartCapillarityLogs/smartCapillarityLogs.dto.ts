...
export class SmartCapillarityLogsDTO implements Readonly<SmartCapillarityLogsDTO> {
  ...
  public static from(dto: Partial<SmartCapillarityLogsDTO>) {
    const it = new SmartCapillarityLogsDTO();
  ...
  public static fromEntity(entity: SmartCapillarityLogs) {
    return this.from({
  ...
  public static toEntity(dto: Partial<SmartCapillarityLogsDTO>) {
    const givenData = new SmartCapillarityLogs();
