...
export class UserAuthDTO implements Readonly<UserAuthDTO> {
  ...
  public static from(dto: Partial<UserAuthDTO>) {
    const it = new UserAuthDTO();
  ...
  public static toEntity(dto: Partial<UserAuthDTO>) {
